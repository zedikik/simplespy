settings = {    SaveDecompileLogs = true, -- saves decompile logs so you dont have to decompile again
	...
	PathToDump = {game.Players.LocalPlayer.Character} -- path to dump
...
getgenv().abss = -15 -- the offset of the cursor had to make a global var so i can calculate the exact position
...
if not _G.SimpleSpyExecuted then
	local succeeded, err = pcall(function()
		...
		bringBackOnResize()
		SimpleSpy2.Parent = game.Players.LocalPlayer.PlayerGui
